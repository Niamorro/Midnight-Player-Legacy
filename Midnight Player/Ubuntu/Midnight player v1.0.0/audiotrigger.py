...
class AudioTrigger(QThread):
    ...
    def set_audio_file(self, file_path):
        ...
        probe = subprocess.run(['ffprobe', '-v', 'quiet', '-print_format', 'json', '-show_streams', file_path], capture_output=True)
        ...
        self.input_stream = subprocess.Popen(command, stdout=subprocess.PIPE, stderr=subprocess.DEVNULL)
